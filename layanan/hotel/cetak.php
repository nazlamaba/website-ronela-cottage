                ...
                <div class="card">
                    ...
                    <div class="card-content">
                        <div class="row">
                            ...
                            $sr = mysqli_query($conn, 'select * from reserv_penginapan where id_penginapan="'.$id_penginapan.'" ');
                            ...
                            ?>
									...
									?>
                                            ...
                                            <div class="input-field">
                                                <p>Tanggal Masuk</p>
                                                <input type="text" id="to" value="<?=$fr['tgl_masuk'];?>">
                                            </div>
                            ...
                            <div class="col s6">
                                <div class="input-field">
                                    <p>No Kamar</p>
                                    <input type="text" id="depat" value="<?=$fr['no_kamar'];?>">
                                </div>
                                <div class="input-field">
                                    <p>Tanggal Keluar</p>
                                    <input type="text" id="seat" value="<?=$fr['tgl_keluar'];?>">
                                </div>
